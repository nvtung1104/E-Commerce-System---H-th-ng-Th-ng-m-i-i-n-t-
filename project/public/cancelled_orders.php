...
<div class="my-orders-container">
    <div class="orders-header">
        ...
        <p>Các đơn hàng đã bị hủy bỏ</p>
    </div>
    
    <?php if (empty($orders)): ?>
        <div class="empty-orders">
            <div class="empty-orders-icon">❌</div>
            <h2>Không có đơn hàng bị hủy</h2>
            <p>Tuyệt vời! Bạn chưa hủy đơn hàng nào.</p>
            ...
            <div class="order-card">
                ...
                <div class="order-footer">
                    ...
                    <div class="order-actions">
                        ...
                        <a href="order_detail.php?id=<?php echo $order['id']; ?>" class="btn-action btn-detail">Xem Chi Tiết</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
